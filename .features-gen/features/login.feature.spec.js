...
test.describe('Login', () => {
  ...
  test('Login com senha inválida', async ({ Given, When, Then, And, page }) => { 
    await Given('que o usuário acessa a página de login', null, { page }); 
...
const bddFileData = [ // bdd-data-start
  ...
  {"pwTestLine":26,"pickleLine":23,"tags":[],"steps":[{"pwStepLine":27,"gherkinStepLine":24,"keywordType":"Context","textWithKeyword":"Given que o usuário acessa a página de login","stepMatchArguments":[]},{"pwStepLine":28,"gherkinStepLine":25,"keywordType":"Action","textWithKeyword":"When informa CPF válido","stepMatchArguments":[]},{"pwStepLine":29,"gherkinStepLine":26,"keywordType":"Action","textWithKeyword":"And iforma senha \"111111\"","stepMatchArguments":[{"group":{"start":13,"value":"\"111111\"","children":[{"start":14,"value":"111111","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":30,"gherkinStepLine":27,"keywordType":"Outcome","textWithKeyword":"Then deve visualizar a mensagem \"Acesso negado. Por favor, tente novamente.\"","stepMatchArguments":[{"group":{"start":27,"value":"\"Acesso negado. Por favor, tente novamente.\"","children":[{"start":28,"value":"Acesso negado. Por favor, tente novamente.","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]}]},
]; // bdd-data-end